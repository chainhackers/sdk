      ...
      <SheetBottomPanelContent className={cn("!h-auto !max-h-[70%]", "p-5 sm:p-6")}>
        <div className="grid grid-cols-2 gap-x-4 sm:gap-x-6 gap-y-3 sm:gap-y-4 text-sm">
          <div>
            ...
            <p className="font-medium text-base text-card-foreground">{winChance}%</p>
          </div>
          <div>
            <p className="text-muted-foreground font-medium">RNG fee:</p>
            <p className="font-medium text-base text-card-foreground">{rngFee} POL</p>
          </div>
          <div>
            <p className="text-muted-foreground font-medium">Target payout:</p>
            <p className="font-medium text-base text-card-foreground">{targetPayout} POL</p>
          </div>
          <div>
            <p className="text-muted-foreground font-medium">Gas price:</p>
            <p className="font-medium text-base text-card-foreground">{gasPrice}</p>
          </div>
        </div>
