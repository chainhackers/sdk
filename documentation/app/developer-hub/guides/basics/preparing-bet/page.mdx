...
Before to place a bet, you need to prepare it in order to maximize the chances of it being accepted
...
// 2.4 Keno - Get a ball of multiple balls (1 to 40 but the max number depends on the configuration)
