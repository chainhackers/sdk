...
export function LeaderboardRankingTab({
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* Claim Button */}
      <Button
        className="bg-primary hover:bg-primary/89 text-white font-semibold rounded-[8px] h-[32px] px-4 text-[14px] w-full"
      >
      ...
      {remainingEntries.length > 0 && (
        <LeaderboardRankingList entries={remainingEntries} />
      )}
