...
export class BetSwirlWagmiClient extends BetSwirlClient {
    ...
    static init(
        ...
        return new BetSwirlWagmiClient(wagmiConfig, options);
    }
}

export function initBetSwirlWagmiClient(
    wagmiConfig: WagmiConfig,
    options?: BetSwirlClientOptions
): BetSwirlWagmiClient {
    return BetSwirlWagmiClient.init(wagmiConfig, options);
}
