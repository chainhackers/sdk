import { BetSwirlWallet, type BetSwirlEventData, type BetSwirlFunctionData } from "@betswirl/sdk-core";
import { call, getPublicClient, getTransactionReceipt, readContract, readContracts, simulateContract, waitForTransactionReceipt, watchContractEvent, writeContract, type Config as WagmiConfig } from "@wagmi/core";
...
export class WagmiBetSwirlWallet extends BetSwirlWallet {
    ...
    >(
        functionData: TFunctionData,
        gasPrice?: bigint
    ): Promise<CallReturnType | TReturnType> {
    ...
    async readContracts<TFunctionDatas extends BetSwirlFunctionData<Abi, string, readonly any[]>[], TReturnTypes extends any[]>(
    ...
    watchContractEvent<TEventData extends BetSwirlEventData<Abi, string, any>>(
        ...
        return watchContractEvent(this.wagmiConfig, {
            ...
            onLogs: (logs) =>
                eventData.callbacks.onLogs?.(logs)
            ,
